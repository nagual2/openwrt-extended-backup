...
- Для подготовки релиза используйте `./scripts/release.sh <новая-версия>` — скрипт обновит `VERSION`, добавит шаблон секции в `CHANGELOG.md`, создаст коммит и аннотированный тег.
